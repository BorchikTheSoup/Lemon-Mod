package net.Borchik.lemonmod.block;
...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> LEMON_CROP = BLOCKS.register("lemon_crop",
            () -> new LemonCropBlock(BlockBehaviour.Properties.copy(Blocks.WHEAT).noOcclusion().noCollission()));
    ...
    private static <T extends Block>RegistryObject<Item> registerBlockItem(String name, RegistryObject<T> block) {
        return net.Borchik.lemonmod.item.Moditems.ITEMS.register(name, ()-> new BlockItem(block.get(), new Item.Properties()));
    }
